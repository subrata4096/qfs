...
then 
	...
	qfscodedirname="qfs-original"
        qfsclientBinaryPath="/home/ubuntu/codes/qfs-original/build/debug/examples/cc/qfssample -s $metaServerIp -p 20000 -f $numFiles"
...
then
	...
	qfscodedirname="qfs-repair"
        qfsclientBinaryPath="/home/ubuntu/codes/qfs-repair/build/debug/examples/cc/qfssample -s $metaServerIp -p 20000 -f $numFiles"
else
   exit 1
fi
...
./kill_meta_server.sh
$qfsdir/examples/sampleservers/sample_setup.py -c /home/ubuntu/sample_setup.cfg -a uninstall

$qfsdir/examples/sampleservers/sample_setup.py -c /home/ubuntu/sample_setup.cfg -a install
